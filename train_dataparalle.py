...
def parse_args(argv=None):
    ...
    parser.add_argument('--train_recmolcache', type=str, required=False,
                        ...
                        default="/home/dbw/PythonProject/DeepPocket_pp/scPDB_new.molcache2")
...
def train(gmaker_img, gmaker_mask, args, device, total=None):
    ...
    # scheduler = WarmupCosineAnnealingLR(optimizer, warmup_epochs=3, max_epochs=num_epochs+10, warmup_start_lr=1e-3, min_lr=1e-6)
